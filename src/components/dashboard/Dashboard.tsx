  ...
  return (
    <div className="">
      ...
      <div className="w-[100%] p-[20px] bg-[#B21D6E] relative">
        ...
        {user.holder.jointNames ? <span className="font-medium text-lg"> {user.holder.jointNames}</span> : <span className="font-medium text-lg"> {user.holder.firstName}</span> }
          ...
          <div className="flex items-center gap-[10px] mt-[10px]">
            <div className="p-[5px_20px] rounded-full bg-white text-[#B21D6E] text-[12px]">
              +
            </div>
            <Link
              className="p-[5px_20px] rounded-full bg-white text-[#B21D6E] text-[12px]"
      ...
      <div className="p-[20px]">
        ...
        <div className="w-full rounded-[5px] overflow-hidden border border-[#B21D6E]">
          <div className="p-[10px_20px] bg-[#B21D6E] text-white text-[14px]">
            Bank accounts(1)
          </div>
